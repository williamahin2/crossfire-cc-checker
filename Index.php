...
<div class="card col-sm-8">
  <h5 class="card-body h6">TESTADOR DE CC - CrossFire</h5>
  <div class="card-body">
    <center><span>[#CrossFire]</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">CC Details</label>
</div>
</div>
<center>
...
<div class="md-form">
	...
	<span>Disapproved:</span>&nbsp<span id="cDie" class="badge badge-danger"> 0</span>
